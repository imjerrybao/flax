<?php
namespace Icecave\Flax\TypeCheck\Exception;

final class UnexpectedArgumentValueException extends UnexpectedInputException
{
    public function __construct($parameterName, $index, $value, $expectedType, \Exception $previous = null, \Icecave\Flax\TypeCheck\TypeInspector $typeInspector = null)
    {
        if (null === $typeInspector) {
            $typeInspector = new \Icecave\Flax\TypeCheck\TypeInspector();
        }
