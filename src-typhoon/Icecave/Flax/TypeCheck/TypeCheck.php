...
abstract class TypeCheck
{
    ...
    {
        $validatorClassName = '\\Icecave\\Flax\\TypeCheck\\Validator\\' . $className . 'TypeCheck';
    ...
    {
        return new \Eloquent\Typhoon\Configuration\RuntimeConfiguration(\Eloquent\Cosmos\ClassName::fromString('\\Icecave\\Flax\\TypeCheck'), false);
    }
